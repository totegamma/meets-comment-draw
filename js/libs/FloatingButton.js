...
const CreateFloatingButton = function() {

    var buttonSize = (Math.max(window.innerWidth, window.innerHeight) > 768) ? 100 : 80;
    ...
    var FloatingButton = {
        ...
        onClick: null,
        init: function init(elementId, text) {
            ...
            applyStyle.call(this, {
                ...
                borderRadius: '10px',
                position: 'absolute',
                top: getOffset(document.body.clientHeight, this.config.margin + buttonCount*this.config.margin),
            ...
            // add Text
            this.dom.innerHTML = text || 'Button';
